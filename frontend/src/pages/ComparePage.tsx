  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900">Vergelijken</h1>
                  ...
                  <table className="w-full text-sm text-left">
                    <thead className="bg-slate-50 text-slate-500 font-medium border-b border-slate-200">
                      <tr>
                        ...
                        <th className="px-3 py-2 sm:px-6 sm:py-3">Oude prijs</th>
                        <th className="px-3 py-2 sm:px-6 sm:py-3">Nieuwe prijs</th>
                        <th className="px-3 py-2 sm:px-6 sm:py-3 text-right">Verschil</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                      {result.price_changes.map((c) => (
                        <tr key={c.product.id} className="hover:bg-slate-50/50">
                          ...
                          <td className="px-3 py-2 sm:px-6 sm:py-3 text-slate-500">&euro;{c.old_price.toFixed(2)}</td>
                          <td className="px-3 py-2 sm:px-6 sm:py-3 font-medium text-slate-900">&euro;{c.new_price.toFixed(2)}</td>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left">
                    <thead className="bg-slate-50 text-slate-500 font-medium border-b border-slate-200">
                      <tr>
                        <th className="px-3 py-2 sm:px-6 sm:py-3">Product</th>
                        <th className="px-3 py-2 sm:px-6 sm:py-3 text-right">Status</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-slate-100">
                      {result.bonus_changes.map((c) => (
                        <tr key={c.product.id} className="hover:bg-slate-50/50">
                          <td className="px-3 py-2 sm:px-6 sm:py-3 font-medium text-slate-900">{c.product.title}</td>
                          <td className="px-3 py-2 sm:px-6 sm:py-3 text-right">
                            {c.is_bonus ? (
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm text-left">
          <thead className="bg-slate-50 text-slate-500 font-medium border-b border-slate-200">
            <tr>
              <th className="px-3 py-2 sm:px-6 sm:py-3">Product</th>
              <th className="px-3 py-2 sm:px-6 sm:py-3">Merk</th>
              <th className="px-3 py-2 sm:px-6 sm:py-3 text-right">Prijs</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-slate-100">
            {products.map((p) => (
              <tr key={p.id} className="hover:bg-slate-50/50">
                ...
                <td className="px-3 py-2 sm:px-6 sm:py-3 text-slate-600">{p.brand}</td>
                <td className="px-3 py-2 sm:px-6 sm:py-3 text-right font-medium text-slate-900">
